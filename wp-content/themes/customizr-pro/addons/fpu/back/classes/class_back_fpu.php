...
class TC_back_fpu {
  ...
  function tc_customize_controls_js_css() {
    ...
    if ( ! in_array( $theme_name, array( 'customizr-pro', 'hueman-pro' ) ) &&
    ...
    $tc_show_img      = array( "{$plug_option_prefix}[tc_show_fp_img_override]", "{$plug_option_prefix}[tc_thumb_shape]", "{$plug_option_prefix}[tc_center_fp_img]", "{$plug_option_prefix}[tc_resp_fp_img]" );
