    ...
    $this->action_wp_footer_settings();
      ...
      function action_wp_footer_settings() {
            ...
            if ( is_string( $post_type ) && ! empty( $post_type ) ) {
                  ...
                  if ( is_object( $post_type ) && ! is_wp_error( $post_type ) ) {
                        ...
                        if ( isset( $cpt_text ) ) {
                              ...
                              $click_handle_text = sprintf( __( 'Older %s', 'customizr-pro' ), $cpt_text );
                              unset( $cpt_text );
                        }
                  }
            }
            ...
            $js_settings = array(
                  ...
                  'totop'            => esc_js( __( 'Scroll back to top', 'customizr-pro' ) ),
    ...
    ?><script type="text/javascript">
      ...
      private function default_footer() {
            ...
            $credits = sprintf(
              ...
              __( 'Proudly powered by WordPress', 'customizr-pro' )
            );
            $credits .= sprintf(
              __( 'Theme: %1$s.', 'customizr-pro' ),
