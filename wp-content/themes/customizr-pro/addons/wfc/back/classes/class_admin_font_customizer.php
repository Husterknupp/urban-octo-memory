...
class TC_admin_font_customizer {
	...
	function __construct () {
        ...
        $this -> font_weight_list = array(
				'normal' 	=> __( 'normal', 'customizr-pro' ),
				'bold' 		=> __( 'bold', 'customizr-pro' ),
				'bolder' 	=> __( 'bolder', 'customizr-pro' ),
				'lighter' 	=> __( 'lighter', 'customizr-pro' ),
				100 		=> 100,
				200 		=> 200,
				300 		=> 300,
				400 		=> 400,
		...
		$this -> font_style_list = array(
				'inherit' 	=> __( 'inherit', 'customizr-pro' ),
				'italic' 	=> __( 'italic', 'customizr-pro' ),
				'normal'	=> __( 'normal', 'customizr-pro' ),
				'oblique'	=> __( 'oblique', 'customizr-pro' )
		);

		$this -> text_align_list = array(
				'center' 	=> __( 'center', 'customizr-pro' ),
				'justify' 	=> __( 'justify', 'customizr-pro' ),
				'inherit' 	=> __( 'inherit', 'customizr-pro' ),
		...
		$this -> text_decoration_list =  array(
				'none'			=> __( 'none', 'customizr-pro' ),
				'inherit'		=> __( 'inherit', 'customizr-pro' ),
				'line-through' => __( 'line-through', 'customizr-pro' ),
				'overline'		=> __( 'overline', 'customizr-pro' ),
				'underline'		=> __( 'underline', 'customizr-pro' )
		);

		$this -> text_transform_list =  array(
				'none'			=> __( 'none', 'customizr-pro' ),
				'inherit'		=> __( 'inherit', 'customizr-pro' ),
				'capitalize' 	=> __( 'capitalize', 'customizr-pro' ),
				'uppercase'		=> __( 'uppercase', 'customizr-pro' ),
				'lowercase'		=> __( 'lowercase', 'customizr-pro' )
		);
	...
	function tc_get_static_effect_list() {
  		return 	apply_filters( 'tc_static_effect_list',
  				array(
  					...
  					'none'				=> array( __('No effect' , 'customizr-pro' ) , 'no-effect', ''),
  					'emboss' 			=> array('Emboss', 'font-effect-emboss', '#ddd'),
  					'3d-one' 			=> array( __('3D one' , 'customizr-pro' ) , 'font-effect-3d-one', '#fff'),
  					'3d-two' 			=> array( __('3D two' , 'customizr-pro' ) , 'font-effect-3d-two', '#555'),
  					...
  					'shadow-soft' 		=> array( __('Shadow soft' , 'customizr-pro' ) , 'font-effect-shadow-soft', '#5a5a5a'),
  					'shadow-simple' 	=> array( __('Shadow simple' , 'customizr-pro' ) , 'font-effect-shadow-simple', '#5a5a5a'),
  					'shadow-distant' 	=> array( __('Shadow distant' , 'customizr-pro' ) , 'font-effect-shadow-distant', '#5a5a5a'),
  					'shadow-close-one' 	=> array( __('Shadow close one' , 'customizr-pro' ) , 'font-effect-shadow-close-one', '#5a5a5a'),
  					'shadow-close-two' 	=> array( __('Shadow close two' , 'customizr-pro' ) , 'font-effect-shadow-close-two', '#5a5a5a'),
  					'shadow-multiple' 	=> array( __('Shadow multiple' , 'customizr-pro' ) , 'font-effect-shadow-multiple', '#222'),
  					'vintage-retro' 	=> array( __('Vintage retro' , 'customizr-pro' ) , 'font-effect-vintage-retro', '#5a5a5a'),
  					'neon-blue' 		=> array( __('Neon blue' , 'customizr-pro' ) , 'font-effect-neon-blue', '#fff'),
  					'neon-green' 		=> array( __('Neon green' , 'customizr-pro' ) , 'font-effect-neon-green', '#fff'),
  					'neon-orange' 		=> array( __('Neon orange' , 'customizr-pro' ) , 'font-effect-neon-orange', '#fff'),
  					'neon-pink' 		=> array( __('Neon pink' , 'customizr-pro' ) , 'font-effect-neon-pink', '#fff'),
  					'neon-red' 			=> array( __('Neon red' , 'customizr-pro' ) , 'font-effect-neon-red', '#fff'),
  					'neon-grey' 		=> array( __('Neon grey' , 'customizr-pro' ) , 'font-effect-neon-grey', '#fff'),
  					'neon-black' 		=> array( __('Neon black' , 'customizr-pro' ) , 'font-effect-neon-black', '#fff'),
  					'neon-white' 		=> array( __('Neon white' , 'customizr-pro' ) , 'font-effect-neon-white', '#fff'),
      ...
      wp_localize_script(
          ...
          'TCFontAdmin', apply_filters('tc_font_customizer_control_params',
            array(
                ...
                'Translations'		 			=> array(
                	'reset_all_button' 	=> __('Reset all' , 'customizr-pro' ),
                	'reset_all_confirm'	=> __('All settings reset to default' , 'customizr-pro' ),
                	'reset_all_warning'	=> __('Are you sure you want to reset all your font settings to default?' , 'customizr-pro' ),
                	'reset_all_yes'		=> __('Yes' , 'customizr-pro' ),
                	'reset_all_no'		=> __('No' , 'customizr-pro' ),
                  'This selector has already been added.' => __('This selector has already been added.','customizr-pro' ),
                  'Custom' => __('Custom', 'customizr-pro' ),
                  'Please specify a CSS selector' => __( 'Please specify a CSS selector', 'customizr-pro' ),
                  'Select a font family' => __('Select a font family' , 'customizr-pro' ),
                  'Pre-defined selectors' => __( 'Pre-defined selectors', 'customizr-pro' ),
                  'Define a custom selector' => __( 'Define a custom selector', 'customizr-pro' ),
                  'Web Safe Fonts' => __( 'Web Safe Fonts', 'customizr-pro' ),
                  'Google Fonts' => __( 'Google Fonts', 'customizr-pro' ),
                  'Please confirm the removal of the customizations for' => __( 'Please confirm the removal of the customizations for', 'customizr-pro' ),
                  'Make sure to use valid css selectors.' => __( 'Make sure to use valid css selectors.', 'customizr-pro' ),
                  'This css selector is not valid.' => __( 'This css selector is not valid.', 'customizr-pro' ),
                  'This selector does not exist in this context.' => __('This selector does not exist in this context.', 'customizr-pro' ),
                  'Select' => __( 'Select', 'customizr-pro' )
                ),
	...
	function tc_db_actions() {
  	...
  	function tc_plugin_action_links( $links, $file ) {
		if ( $file == plugin_basename( dirname( dirname( dirname(__FILE__) ) ). '/' . basename( TC_wfc::$instance -> plug_file ) ) ) {
			$links[] = '<a href="' . admin_url( 'customize.php' ) . '">'.__( 'Settings', 'customizr-pro' ).'</a>';
			$links[] = '<a href="' . admin_url( 'options.php?page=tc-system-info' ) . '">'.__('System Informations', 'customizr-pro').'</a>';
		}
		return $links;
	  }
