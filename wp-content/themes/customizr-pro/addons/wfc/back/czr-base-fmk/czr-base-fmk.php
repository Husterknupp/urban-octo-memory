        ...
        function ac_load_additional_controls_js() {
            ...
            if ( version_compare( $wp_version, '5.4.2' , '>=' ) ) {
                wp_localize_script(
                  ...
                  array(
                    'clear'            => __( 'Clear', 'customizr-pro' ),
                    'clearAriaLabel'   => __( 'Clear color', 'customizr-pro' ),
                    'defaultString'    => __( 'Default', 'customizr-pro' ),
                    'defaultAriaLabel' => __( 'Select default color', 'customizr-pro' ),
                    'pick'             => __( 'Select Color', 'customizr-pro' ),
                    'defaultLabel'     => __( 'Color value', 'customizr-pro' )
                  )
                );
            }
            ...
            wp_localize_script(
                ...
                apply_filters( 'czr_js_customizer_control_params' ,
                  array(
                      ...
                      'i18n' => array(
                            'edit' => __('Edit', 'customizr-pro'),
                            'close' => __('Close', 'customizr-pro'),
                            'notset' => __('Not set', 'customizr-pro'),
                            'successMessage' => __('Done !', 'customizr-pro'),

                            'readDocumentation' => __('Learn more about this in the documentation', 'customizr-pro'),
                            'Settings' => __('Settings', 'customizr-pro'),
                            'Options for' => __('Options for', 'customizr-pro'),

                            // img upload translation
                            'select_image'        => __( 'Select Image', 'customizr-pro' ),
                            'change_image'        => __( 'Change Image', 'customizr-pro' ),
                            'remove_image'        => __( 'Remove', 'customizr-pro' ),
                            'default_image'       => __( 'Default', 'customizr-pro'  ),
                            'placeholder_image'   => __( 'No image selected', 'customizr-pro' ),
                            'frame_title_image'   => __( 'Select Image', 'customizr-pro' ),
                            'frame_button_image'  => __( 'Choose Image', 'customizr-pro' ),

                            'Customizing' => __('Customizing', 'customizr-pro'),
                      ),
        ...
        function ac_set_ajax_czr_tmpl() {
            ...
            if ( !check_ajax_referer( $action, 'nonce', false ) ) {
                 wp_send_json_error( array(
                  'code' => 'invalid_nonce',
                  'message' => __( 'ac_set_ajax_czr_tmpl => Security check failed.', 'customizr-pro' ),
                ) );
            }
        ...
        function ac_get_all_modules_tmpl( $html, $requested_tmpl = '', $posted_params = array() ) {
            ...
            switch ( $requested_tmpl ) {
                case 'crud-module-part' :
                    ?>
                      <button class="<?php echo $css_attr['open_pre_add_btn']; ?>"><?php _e('Add New', 'customizr-pro'); ?> <span class="fas fa-plus-square"></span></button>
                      <div class="<?php echo $css_attr['pre_add_wrapper']; ?>">
                        ...
                        <div class="<?php echo $css_attr['pre_add_item_content']; ?>">
                          ...
                          <span class="<?php echo $css_attr['cancel_pre_add_btn']; ?> button"><?php _e('Cancel', 'customizr-pro'); ?></span> <span class="<?php echo $css_attr['add_new_btn']; ?> button"><?php _e('Add it', 'customizr-pro'); ?></span>
                        </div>
                      </div>
                    <?php
                break;
                case 'rud-item-part' :
                    ?>
                      <div class="<?php echo $css_attr['item_header']; ?> czr-custom-model">
                        ...
                        <# } #>
                        <div class="<?php echo $css_attr['item_btns']; ?>"><a title="<?php _e('Edit', 'customizr-pro'); ?>" href="javascript:void(0);" class="fas fa-pencil-alt <?php echo $css_attr['edit_view_btn']; ?>"></a>&nbsp;<a title="<?php _e('Remove', 'customizr-pro'); ?>" href="javascript:void(0);" class="fas fa-trash <?php echo $css_attr['display_alert_btn']; ?>"></a></div>
                ...
                case 'rud-item-alert-part' :
                    ?>
                      <p class="czr-item-removal-title"><?php _e('Are you sure you want to remove : <strong>{{ data.title }} ?</strong>', 'customizr-pro'); ?></p>
                      <span class="<?php echo $css_attr['remove_view_btn']; ?> button"><?php _e('Yes', 'customizr-pro'); ?></span> <span class="<?php echo $css_attr['cancel_alert_btn']; ?> button"><?php _e('No', 'customizr-pro'); ?></span>
                    <?php
                break;
    ...
    class CZR_Fmk_Base extends CZR_Fmk_Dyn_Module_Registration {
      ...
      function czr_add_custom_item_to_ajax_results( $items, $page, $context ) {
          if ( is_numeric( $page ) && $page < 1 ) {
              return array_merge(
                  array(
                      array(
                         'title'      => sprintf( '<span style="font-weight:bold">%1$s</span>', __('Set a custom url', 'customizr-pro') ),
                         'type'       => '',
                         'type_label' => '',
                         'object'     => '',
                         'id'         => '_custom_',
      ...
      public function ajax_load_available_items() {
            ...
            if ( !check_ajax_referer( $action, 'nonce', false ) ) {
                 wp_send_json_error( array(
                  'code' => 'invalid_nonce',
                  'message' => __( 'ajax_load_available_items => Security check failed.', 'customizr-pro' ),
                ) );
            }
            ...
            if ( 'post' === $type ) {
                  ...
                  foreach ( $posts as $post ) {
                        ...
                        if ( '' === $post_title ) {
                          ...
                          $post_title = sprintf( __( '#%d (no title)', 'customizr-pro' ), $post->ID );
                        }
                        $items[] = array(
      ...
      public function ajax_search_available_items() {
            ...
            if ( empty( $items ) ) {
                wp_send_json_success( array( 'message' => __( 'No results found.', 'customizr-pro') ) );
            } else {
                wp_send_json_success( array(
