    ...
    function tc_customizer_map( $get_default_option = false ) {
        ...
        $add_section 					= array(
				                        'add_section'           =>   array(
				                                        'tc_font_customizer_settings'   => array(
				                                                                            'title'         =>  __( 'Font Customizer' , 'customizr-pro' ),
				                                                                            'priority'      =>  0,
				                                                                            'description'   =>  __( 'Play with beautiful fonts!' , 'customizr-pro' )
				                                        ),
				                        )
        ...
        $tc_font_customizer_settings 	= array(
             TC_wfc::$opt_name => array(
                ...
                'label'     => __('Manage your customized text elements.', 'customizr-pro'),
                'description' => __( 'The New WFC' , 'customizr-pro'),
    ...
    function tc_get_selector_title_map() {
      if ( isset( $this -> tc_selector_title_map ) )
        return apply_filters( 'all_selectors_title_map' , $this -> tc_selector_title_map );
        	...
        	array(
        		'body' 					=> __( 'Default website font' , 'customizr-pro' ),
        		'site_title'			=> __( 'Site title' , 'customizr-pro' ),
        		'site_description' 		=> __( 'Site description' , 'customizr-pro' ),
        		'menu_items' 			=> __( 'Menu items' , 'customizr-pro' ),
        		'slider_title' 			=> __( 'Slider title' , 'customizr-pro' ),
        		'slider_text' 			=> __( 'Slider text' , 'customizr-pro' ),
        		'slider_button' 		=> __( 'Slider button' , 'customizr-pro' ),
        		'fp_title' 				=> __( 'Featured pages title' , 'customizr-pro' ),
        		'fp_text' 				=> __( 'Featured pages text' , 'customizr-pro' ),
        		'fp_btn' 				=> __( 'Featured pages button' , 'customizr-pro' ),
        		'single_post_title' 	=> __( 'Single post/page titles' , 'customizr-pro' ),
        		'post_list_titles' 		=> __( 'Post list titles' , 'customizr-pro' ),
        		'archive_titles' 		=> __( 'Archive/Blog titles' , 'customizr-pro' ),
        		'post_content' 			=> __( 'Post content / excerpt' , 'customizr-pro' ),
        		'post_metas' 			=> __( 'Post metas' , 'customizr-pro' ),
        		'post_links' 			=> __( 'Links in post/pages' , 'customizr-pro' ),
        		'post_hone' 			=> __( 'H1 headings' , 'customizr-pro' ),
        		'post_htwo' 			=> __( 'H2 headings' , 'customizr-pro' ),
        		'post_hthree' 			=> __( 'H3 headings' , 'customizr-pro' ),
        		'post_hfour' 			=> __( 'H4 headings' , 'customizr-pro' ),
        		'post_hfive' 			=> __( 'H5 headings' , 'customizr-pro' ),
        		'post_hsix' 			=> __( 'H6 headings' , 'customizr-pro' ),
        		'blockquote' 			=> __( 'Blockquotes' , 'customizr-pro' ),
        		'comment_title' 		=> __( 'Comments title' , 'customizr-pro' ),
        		'comment_author' 		=> __( 'Comments author' , 'customizr-pro' ),
        		'comment_content'		=> __( 'Comments content' , 'customizr-pro' ),
        		'sidebars_widget_title' => __( 'Sidebar widget titles' , 'customizr-pro' ),
        		'sidebars_links' 		=> __( 'Links in sidebars' , 'customizr-pro' ),
        		'footer_widget_title' 	=> __( 'Widget titles' , 'customizr-pro' ),
        		'footer_credits' 		=> __( 'Footer credits' , 'customizr-pro' ),
            'footer_credits_links'    => __( 'Footer credits links' , 'customizr-pro' )
        	)//end of array
		);//end of filter
  ...
  //@return the subsets or the google fonts
    ...
    $gfonts_decoded = self::$gfonts_decoded;
		...
		$subsets['all-subsets'] = sprintf( '%1$s ( %2$s %3$s )',
			__( 'All languages' , 'customizr-pro' ),
			count($gfonts_decoded['items']) + count( $this -> get_cfonts() ),
			__('fonts' , 'customizr-pro' )
		);
