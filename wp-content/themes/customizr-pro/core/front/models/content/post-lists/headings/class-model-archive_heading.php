...
class CZR_archive_heading_model_class extends CZR_Model {
  ...
  function czr_fn_get_posts_list_pre_title( $context = null ) {
    ...
    if ( in_array( $context, array( 'day', 'month', 'year') ) ) {
      switch ( $context ) {
        case 'day'            : return __( 'Daily Archives:' , 'customizr-pro' );
        case 'month'          : return __( 'Monthly Archives:', 'customizr-pro' );
        case 'year'           : return __( 'Yearly Archives:', 'customizr-pro' );
      }
    }
  ...
  function czr_fn_get_posts_list_title_content( $context = null ) {
    ...
    switch ( $context ) {
      ...
      case 'month'             : return '<span>' . get_the_date( _x( 'F Y' , 'monthly archives date format' , 'customizr-pro' ) ) . '</span>';
      case 'year'              : return '<span>' . get_the_date( _x( 'Y' , 'yearly archives date format' , 'customizr-pro' ) ) . '</span>';
