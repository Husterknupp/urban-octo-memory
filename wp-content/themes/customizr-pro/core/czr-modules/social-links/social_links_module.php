    ...
    $CZR_Fmk_Base_fn() -> czr_pre_register_dynamic_module( array(
            ...
            'localized_control_js' => array(
                ...
                'params' => array(
                    ...
                    'i18n' => array(
                        ...
                        'Select a social icon' => __('Select a social icon', 'customizr-pro'),
                        'Follow us on' => __('Follow us on', 'customizr-pro'),
                        'Done !' => __('Done !', 'customizr-pro'),
                        'New Social Link created ! Scroll down to edit it.' => __('New Social Link created ! Scroll down to edit it.', 'customizr-pro'),
                    )
        ...
        'tmpl' => array(
            'pre-item' => array(
                'social-icon' => array(
                    'input_type'  => 'select',
                    'title'       => __('Select an icon', 'customizr-pro')
                ),
                'social-link'  => array(
                    'input_type'  => 'text',
                    'title'       => __('Social link url', 'customizr-pro'),
                    'notice_after'      => __('Enter the full url of your social profile (must be valid url).', 'customizr-pro'),
                    'placeholder' => __('http://...,mailto:...,...', 'customizr-pro')
                )
            ),
            'mod-opt' => array(
                'social-size' => array(
                    'input_type'  => 'number',
                    'title'       => __('Size in px', 'customizr-pro'),
                    'step'        => 1,
                    'min'         => 5,
            ...
            'item-inputs' => array(
                'social-icon' => array(
                    'input_type'  => 'select',
                    'title'       => __('Social icon', 'customizr-pro')
                ),
                'social-link'  => array(
                    'input_type'  => 'text',
                    'title'       => __('Social link', 'customizr-pro'),
                    'notice_after'      => __('Enter the full url of your social profile (must be valid url).', 'customizr-pro'),
                    'placeholder' => __('http://...,mailto:...,...', 'customizr-pro')
                ),
                'title'  => array(
                    'input_type'  => 'text',
                    'title'       => __('Title', 'customizr-pro'),
                    'notice_after'      => __('This is the text displayed on mouse over.', 'customizr-pro'),
                ),
                'social-color'  => array(
                    'input_type'  => 'color',
                    'title'       => sprintf( '%1$s <i>%2$s %3$s</i>', __('Icon color', 'customizr-pro'), __('default:', 'customizr-pro'), 'rgba(255,255,255,0.7)' ),
                    'notice_after'      => __('Set a unique color for your icon.', 'customizr-pro'),
                    'transport' => 'postMessage'
                ),
                'social-target' => array(
                    'input_type'  => 'nimblecheck',
                    'title'       => __('Link target', 'customizr-pro'),
                    'notice_after'      => __('Check this option to open the link in a another tab of the browser.', 'customizr-pro'),
...
function czr_fn_validate_callback__czr_social_module( $validity, $socials ) {
  ...
  $malformed_message = __( 'An error occurred: malformed social links', 'customizr-pro');
  ...
  return new WP_Error( 'required', __( 'Please fill the social link inputs with a valid URLs', 'customizr-pro' ), $ids_malformed_url );
}
