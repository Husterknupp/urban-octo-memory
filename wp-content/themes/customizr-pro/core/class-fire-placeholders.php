        ...
        $help_blocks = array(
            ...
            array(
                ...
                'cb_params'   => array(
                    ...
                    'element_tag'            => 'aside',
                    'position'               => 'sidebar',
                    'help_title'             => __( 'The left sidebar has no widgets', 'customizr-pro' ),
                    'help_message'           =>  sprintf( __( 'Add widgets to this sidebar %s or %s.', 'customizr-pro' ),
                        sprintf( '<a href="%1$s" title="%2$s">%3$s</a>',
                            czr_fn_get_customizer_url( array( 'panel' => 'widgets' ) ),
                            __( 'Add widgets', 'customizr-pro' ),
                            __( 'now', 'customizr-pro' )
                        ),
                        sprintf('<a class="tc-inline-dismiss-notice" data-position="sidebar" href="#" title="%1$s">%1$s</a>',
                          __( 'dismiss this notice', 'customizr-pro')
                        )
                    ),
                    'help_secondary_message' => sprintf('<p><i>%1s <a href="http:%2$s" title="%3$s" target="blank" rel="noopener noreferrer">%4$s</a></i></p>',
                        __( 'You can also remove this sidebar by changing the current page layout.', 'customizr-pro' ),
                        '//docs.presscustomizr.com/article/107-customizr-theme-options-pages-and-posts-layout',
                        __( 'Changing the layout in the Customizr theme' , 'customizr-pro'),
                        __( 'See the theme documentation.' , 'customizr-pro' )
                    )
                ),
            ...
            array(
                ...
                'cb_params'   => array(
                    ...
                    'element_tag'            => 'aside',
                    'position'               => 'sidebar',
                    'help_title'             => __( 'The right sidebar has no widgets', 'customizr-pro'),
                    'help_message'           => sprintf( __( 'Add widgets to the footer %s or %s.', 'customizr-pro'),
                        sprintf( '<a href="%1$s" title="%2$s">%3$s</a>', czr_fn_get_customizer_url( array( 'panel' => 'widgets') ), __( 'Add widgets', 'customizr-pro'), __('now', 'customizr-pro') ),
            ...
            array(
                ...
                'cb_params'   => array(
                    ...
                    'element_tag'            => 'aside',
                    'position'               => 'footer',
                    'help_title'             => __( 'The footer has no widgets', 'customizr-pro'),
                    'help_message'           => sprintf( __( 'Add widgets to the footer %s or %s.', 'customizr-pro'),
                        sprintf( '<a href="%1$s" title="%2$s">%3$s</a>', czr_fn_get_customizer_url( array( 'panel' => 'widgets') ), __( 'Add widgets', 'customizr-pro'), __('now', 'customizr-pro') ),
                        sprintf('<a class="tc-inline-dismiss-notice tc-dismiss-notice" href="#" title="%1$s">%1$s</a>',
                          __( 'dismiss this notice', 'customizr-pro')
            ...
            array(
                ...
                'cb_params'   => array(
                    ...
                    'help_message'           => __( "You can display your post's featured image here if you have set one.", 'customizr-pro' ),
                    'help_secondary_message' => sprintf( '<p>%1$s</p><p>%2$s</p>',
                        sprintf( __("%s to display a featured image here.", 'customizr-pro'),
                            sprintf( '<strong><a href="%1$s" title="%2$s">%2$s</a></strong>', czr_fn_get_customizer_url( array( "section" => "single_posts_sec") ), __( 'Jump to the customizer now', 'customizr-pro') )
                        ),
                        sprintf( __( "Don't know how to set a featured image to a post? Learn how in the %s.", 'customizr-pro' ),
                            sprintf('<a href="%1$s" title="%2$s" target="_blank">%2$s</a> <span class="tc-external fas fa-external-link-alt"></span>' , esc_url('codex.wordpress.org/Post_Thumbnails#Setting_a_Post_Thumbnail'), __('WordPress documentation' , 'customizr-pro' ) )
                        )
                    ),
                ),
            ...
            array(
                 ...
                 'cb_params'   => array(
                     'dismiss_action'         => 'dismiss_thumbnail_help',
                     'help_message'           =>  __( "You can display your page's featured image here if you have set one.", 'customizr-pro' ),
                     'help_secondary_message' => sprintf( '<p>%1$s</p><p>%2$s</p>',
                         sprintf( __("%s to display a featured image here.", 'customizr-pro'),
                             sprintf( '<strong><a href="%1$s" title="%2$s">%2$s</a></strong>', czr_fn_get_customizer_url( array( "section" => "single_pages_sec" ) ), __( 'Jump to the customizer now', 'customizr-pro') )
                         ),
            ...
            array(
                ...
                'cb_params'   => array(
                    ...
                    'help_message'           =>  __( 'Did you know you can easily speed up your page load by deferring the loading of the non visible images?', 'customizr-pro' ),
                    'help_secondary_message' =>  sprintf( "<p>%s</p>",
                        sprintf( __("%s and check the option 'Load images on scroll' under 'Website Performances' section.", 'customizr-pro'),
                            sprintf( '<strong><a href="%1$s" title="%2$s">%2$s</a></strong>', czr_fn_get_customizer_url( array( "control" => "tc_img_smart_load", "section" => "performances_sec" ) ), __( "Jump to the customizer now", "customizr-pro") )
                        )
                    )
                ),
    ...
    function czr_fn_maybe_add_preview_widget_placeholders( $did_one, $index ) {
        ...
        if ( array_key_exists( $index, $widgets ) ) {
            printf('<div class="widget" data-czr-panel-focus="widgets">%6$s<div class="czr-placeholder-widget"%3$s><h3%4$s>%1$s<br/><span class="zone-name"%5$s>"%2$s"</span></h3></div></div>',
                __('Add widgets to the zone :', 'customizr-pro'),
    ...
    */
    ...
    function czr_fn_help_block_template( $params ) {
        ...
        ?> class="tc-placeholder-wrap <?php echo $element_class ?>" <?php echo czr_fn_stringify_array( $help_block_data ) ?>>
            <span class="tc-admin-notice"><i class="fas fa-user-secret"></i> <?php _e( 'This notice is visible for admin users only.', 'customizr-pro') ?></span>
            ...
            <a class="tc-dismiss-notice" href="#" title="<?php _e( 'dismiss notice', 'customizr-pro' ) ?>"><?php _e( 'dismiss notice', 'customizr-pro' ) ?> x</a>
