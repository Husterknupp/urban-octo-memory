          ...
          <?php
            echo apply_filters(
              ...
              sprintf('<h3>%1$s %2$s %3$s %4$s :D</h3>',
                __( "Good, you've recently upgraded to", "customizr-pro"),
                CZR_IS_PRO ? 'Customizr Pro' : 'Customizr',
                __( "version", "customizr-pro"),
                CUSTOMIZR_VER
              )
            );
          ?>
          <?php
            echo apply_filters(
              ...
              sprintf( '<h4>%1$s <a class="" href="%2$s" title="%3$s" target="_blank">%3$s &raquo;</a></h4>%4$s',
                __( "We'd like to introduce the new features we've been working on.", "customizr-pro"),
                CZR_WEBSITE . "category/customizr-releases/",
                __( "Read the latest release notes" , "customizr-pro" ),
                ! CZR_IS_PRO ? sprintf( '<p style="position: absolute;right: 7px;top: 4px;"><a class="button button-primary upgrade-to-pro" href="%1$s" title="%2$s" target="_blank">%2$s &raquo;</a></p>',
                  ...
                  __( "Upgrade to Customizr Pro", "customizr-pro" )
                ) : ''
              )
            );
          ?>
...
if ( ! class_exists( 'CZR_admin_page' ) ) :
   ...
   */
    function czr_fn_add_welcome_page() {
        $_name = __( 'About Customizr' , 'customizr-pro' );
      ...
      function czr_fn_welcome_panel() {
        ...
        <div id="customizr-admin-panel" class="wrap about-wrap">
          <?php
            $title = sprintf( '<h1 class="need-help-title">%1$s %2$s %3$s :)</h1>',
              __( "Thank you for using", "customizr-pro" ),
              $_theme_name,
              CUSTOMIZR_VER
            );
          ...
          <?php else : ?>
            ...
            <div class="about-text tc-welcome">
              <?php
                printf( '<p>%1$s</p>',
                  sprintf( __( "The best way to start with %s is to read the %s and visit the %s.", "customizr-pro"),
                    $_theme_name,
                    sprintf( '<a href="%1$s" title="%2$s" target="_blank">%2$s</a>', esc_url('docs.presscustomizr.com'), __("documentation", "customizr-pro") ),
                    sprintf( '<a href="%1$s" title="%2$s" target="_blank">%2$s</a>', esc_url('demo.presscustomizr.com'), __("demo website", "customizr-pro") )
                  )
                );
                printf( '<p><a href="#customizr-changelog">%1$s</a></p>',
                  __( "Read the changelog", "customizr-pro")
                );
              ?>
            </div>
          ...
          <?php if ( czr_fn_is_child() ) : ?>
            ...
            <div class="tc-upgrade-notice">
              <p>
              <?php
                printf( __('You are using a child theme of Customizr %1$s : always check the %2$s after upgrading to see if a function or a template has been deprecated.' , 'customizr-pro'),
                  'v'.CUSTOMIZR_VER,
          ...
          <?php if ( ! CZR_IS_PRO ) : ?>
            <div class="changelog">
                ...
                <div class="feature-section col two-col">
                  ...
                  <div class="col">
                    <h3 style="font-size:1.3em;"><?php _e( 'Happy user of Customizr?','customizr-pro' ); ?></h3>
                    <p><?php _e( 'If you are happy with the theme, say it on wordpress.org and give Customizr a nice review! <br />(We are addicted to your feedbacks...)','customizr-pro' ) ?></br>
                  ...
                  <div class="last-feature col">
                    <h3 style="font-size:1.3em;"><?php _e( 'Follow us','customizr-pro' ); ?></h3>
            ...
            <div id="extend" class="changelog">
              <h3 style="text-align:left;font-size:1.3em;"><?php _e("Go Customizr Pro" ,'customizr-pro') ?></h3>
              ...
              <div class="feature-section two-col images-stagger-right">
                ...
                <div class="col" style="float:left">
                  <h4 style="text-align: left;"><?php _e('Easily take your web design one step further' ,'customizr-pro') ?></h4></br>

                  <p style="text-align: left;"><?php _e("The Customizr Pro WordPress theme allows anyone to create a beautiful, professional and mobile friendly website in a few minutes. In the Pro version, you'll get all features included in the free version plus many conversion oriented ones, to help you attract and retain more visitors on your websites." , 'customizr-pro') ?>
                  </p>
                  <p style="text-align:left;">
                      <a class="button-primary review-customizr hu-go-pro-btn" title="<?php _e("Discover Customizr Pro",'customizr-pro') ?>" href="<?php echo esc_url( CZR_WEBSITE . 'customizr-pro?ref=a&utm_source=usersite&utm_medium=link&utm_campaign=customizr-admin-page' ); ?>" target="_blank"><?php _e("Discover Customizr Pro",'customizr-pro') ?> &raquo;</a>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="return-to-dashboard">
          <a href="<?php echo esc_url( self_admin_url() ); ?>"><?php
            is_blog_admin() ? _e( 'Go to Dashboard &rarr; Home','customizr-pro' ) : _e( 'Go to Dashboard','customizr-pro' ); ?></a>
        </div>
   ...
   */
    function czr_fn_print_changelog() {
      ...
      <div id="customizr-changelog" class="changelog">
        <h3><?php printf( __( 'Changelog in version %1$s' , 'customizr-pro' ) , CUSTOMIZR_VER ); ?></h3>
          <p><?php echo $html ?></p>
      </div>
      <?php
    }
    ...
    */
    function czr_fn_config_infos() {
      ...
      ?>
<div class="wrap">
<h3><?php _e( 'System Informations', 'customizr-pro' ); ?></h3>
<h4 style="text-align: left"><?php _e( 'Please include the following informations when posting support requests' , 'customizr-pro' ) ?></h4>
<textarea readonly="readonly" onclick="this.focus();this.select()" id="system-info-textarea" name="tc-sysinfo" title="<?php _e( 'To copy the system infos, click below then press Ctrl + C (PC) or Cmd + C (Mac).', 'customizr-pro' ); ?>" style="width: 800px;min-height: 800px;font-family: Menlo,Monaco,monospace;background: 0 0;white-space: pre;overflow: auto;display:block;">
    ...
    function czr_enqueue_hs_assets() {
        ...
        $script_settings = array(
          ...
          'text' => array(
            ...
            'result_found' => __('We found {count} article that may help:' , 'customizr-pro'),
            'results_found' => __('We found {count} articles that may help:' , 'customizr-pro'),
            'no_results_found' => __('No results found&hellip;' , 'customizr-pro'),
            'enter_search' => __('Please enter a search term.' , 'customizr-pro'),
            'not_long_enough' => __('Search must be at least {minLength} characters.' , 'customizr-pro'),
            'error' => __('There was an error fetching search results.' , 'customizr-pro'),
          ),
          'template' => array(
            ...
            'item' => sprintf( '<li class="article"><a href="{url}" title="%1$s" target="_blank">{name}<span class="article--open-original" ></span></a><p class="article-preview">{preview} ... <a href="{url}" title="%1$s" target="_blank">%2$s</a></p></li>',
              __( 'Read the full article', 'customizr-pro' ),
              __( 'read more', 'customizr-pro' )
            ),
            'after' => '</ul>',
              ...
              <fieldset>
                <div id="frm_field_335_container" class="frm_form_field form-field  frm_top_container helpscout-docs">
                  <label for="field_6woxqa" class="frm_primary_label">
                    <h2><?php _e( 'Search the knowledge base', 'customizr-pro' ); ?></h2>
                    <h4 style="text-align:center;font-style: italic;font-weight: normal;"><?php _e( 'In a few keywords, describe the information you are looking for.', 'customizr-pro' ); ?></h4>
                      <span class="frm_required"></span>
                  </label>
                  <input type="text" id="field_6woxqa" name="item_meta[335]" value="" placeholder="<?php _e( 'Ex. Logo upload', 'customizr-pro' ) ;?>" autocomplete="off">

                  <div class="frm_description"><?php _e('<u>Search tips</u> : If you get too many results, try to narrow down your search by prefixing it with "customizr" for example. If there are no results, try different keywords and / or spelling variations', 'customizr-pro' ); ?> </div>
                </div>
              </fieldset>
            </div>
          </form>
   ...
   class CZR_meta_boxes {
     ...
     */
      ...
      function czr_fn_layout_section_metabox( $screen ) {
         ...
         return array(
            'title'    => __( 'Layout Options' , 'customizr-pro' ),
      ...
      function czr_fn_link_section_metabox( $screen ) {
         ...
         return array(
            'title'    => __( 'Format: link' , 'customizr-pro' ),
      ...
      function czr_fn_quote_section_metabox( $screen ) {
         ...
         return array(
            'title'    => __( 'Format: quote' , 'customizr-pro' ),
      ...
      function czr_fn_video_section_metabox( $screen ) {
         ...
         return array(
            'title'    => __( 'Format: video' , 'customizr-pro' ),
      ...
      function czr_fn_audio_section_metabox( $screen ) {
         ...
         return array(
            'title'    => __( 'Format: audio' , 'customizr-pro' ),
      ...
      function czr_fn_post_format_link_box( $post, $args ) {
         ...
         CZR_meta_boxes::czr_fn_generic_input_view( array(
            ...
            'title'       => array(
                            ...
                            'title_text'  => __( 'Link title', 'customizr-pro'),
                            'title_tag'   => 'h3',

            ),
            'content_before' => CZR_meta_boxes::czr_fn_title_view( array(
                                 'title_text'  => __( 'Enter the title', 'customizr-pro'),
                                 'title_tag'   => 'h4',
                                 'echo'        => false,
                                 'boxed'       => false
                              )
         ...
         CZR_meta_boxes::czr_fn_generic_input_view( array(
            ...
            'custom_args' => 'style="max-width:50%"',
            'title'       => array(
                                 'title_text'  => __( 'Link URL', 'customizr-pro'),
                                 'title_tag'   => 'h3',
            ),

            'content_before' => CZR_meta_boxes::czr_fn_title_view( array(
                                 'title_text'  => __( 'Enter the URL', 'customizr-pro'),
                                 'title_tag'   => 'h4',
                                 'echo'        => false,
                                 'boxed'       => false
                              )
      ...
      function czr_fn_post_format_quote_box( $post, $args ) {
         ...
         CZR_meta_boxes::czr_fn_textarea_view( array(
            ...
            'title'       =>  array(
                                 'title_text'  => __( 'Quote text', 'customizr-pro'),
                                 'title_tag'   => 'h3',
            ),
            'custom_args'    => 'style="max-width:50%"',
            'content_before' =>  CZR_meta_boxes::czr_fn_title_view( array(
                                 'title_text'  => __( 'Enter the text', 'customizr-pro'),
                                 'title_tag'   => 'h4',
                                 'echo'        => false,
                                 'boxed'       => false
                              )
         ...
         CZR_meta_boxes::czr_fn_generic_input_view( array(
            ...
            'title'       =>  array(
                                 'title_text'  => __( 'Quote author', 'customizr-pro'),
                                 'title_tag'   => 'h3',
            ),

            'custom_args' => 'style="max-width:50%"',
            'content_before' => CZR_meta_boxes::czr_fn_title_view( array(
                                 'title_text'  => __( 'Enter the author', 'customizr-pro'),
                                 'title_tag'   => 'h4',
                                 'echo'        => false,
                                 'boxed'       => false
                              )
      ...
      function czr_fn_post_format_audio_box( $post, $args ) {
         ...
         CZR_meta_boxes::czr_fn_generic_input_view( array(
            ...
            'custom_args' => 'style="max-width:50%"',
            'title'       => array(
                                 'title_text'  => __( 'Audio url', 'customizr-pro'),
                                 'title_tag'   => 'h3',
            ),
            'content_before' => CZR_meta_boxes::czr_fn_title_view( array(
                                    'title_text'  => __( 'Enter the audio url', 'customizr-pro'),
                                    'title_tag'   => 'h4',
                                    'echo'        => false,
                                    'boxed'       => false
                              )
      ...
      function czr_fn_post_format_video_box( $post, $args ) {
         ...
         CZR_meta_boxes::czr_fn_generic_input_view( array(
            ...
            'custom_args' => 'style="max-width:50%"',
            'title'       => array(
                                 'title_text'  => __( 'Video url', 'customizr-pro'),
                                 'title_tag'   => 'h3',
            ),
            'content_before' => CZR_meta_boxes::czr_fn_title_view( array(
                                 'title_text'  => __( 'Enter the video url', 'customizr-pro'),
                                 'title_tag'   => 'h4',
                                 'echo'        => false,
                                 'boxed'       => false
                              )
      ...
      function czr_fn_post_layout_box( $post ) {
           ...
           <div class="meta-box-item-content">
             <?php if( $layout_value == null) : ?>
               <p><?php printf(__( 'Default %1$s layout is set to : %2$s' , 'customizr-pro' ), 'page' == $post -> post_type ? __( 'pages' , 'customizr-pro' ):__( 'posts' , 'customizr-pro' ), '<strong>'.$layouts[$tc_sidebar_default_context_layout].'</strong>' ) ?></p>
             <?php endif; ?>

                 <i><?php printf(__( 'You can define a specific layout for %1$s by using the pre-defined left and right sidebars. The default layouts can be defined in the WordPress customizer screen %2$s.<br />' , 'customizr-pro' ),
                  $post -> post_type == 'page' ? __( 'this page' , 'customizr-pro' ):__( 'this post' , 'customizr-pro' ),
                   '<a href="'.admin_url( 'customize.php' ).'" target="_blank">'.__( 'here' , 'customizr-pro' ).'</a>'
                  ); ?>
                 </i>
                 <h4><?php printf(__( 'Select a specific layout for %1$s' , 'customizr-pro' ),
                 $post -> post_type == 'page' ? __( 'this page' , 'customizr-pro' ):__( 'this post' , 'customizr-pro' )); ?></h4>
                 <select name="<?php echo $layout_id; ?>" id="<?php echo $layout_id; ?>">
                 <?php //no layout selected ?>
                  <option value="" <?php selected( $layout_value, $current = null, $echo = true ) ?>> <?php printf(__( 'Default layout %1s' , 'customizr-pro' ),
       ...
       */
        function czr_fn_post_slider_box( $post ) {
          ...
          <div class="meta-box-item-title">
            <h4><label for="<?php echo $post_slider_check_id; ?>"><?php _e( 'Add a slider to this post/page' , 'customizr-pro' ); ?></label></h4>
           </div>
           <div class="meta-box-item-content">
               <?php
     ...
     */
      function czr_fn_get_post_slider_infos( $postid ) {
         ...
         ?>
             <div class="meta-box-item-title">
               <h4><?php _e("Choose a slider", 'customizr-pro' ); ?></h4>
             </div>
         <?php
             //build selectable slider -> ID => label
             //Default in head
             $selectable_sliders = array_merge( array(
               -1 => __( '&mdash; Select a slider &mdash; ' , 'customizr-pro' )
             ), $selectable_sliders );
         ...
         ?>
               <div class="meta-box-item-content">
                 ...
                 ?>
                  ...
                  <i><?php _e( 'To create a new slider : open the media library, edit your images and add them to your new slider.' , 'customizr-pro' ) ?></i>
               </div>

               <div class="meta-box-item-title">
                 <h4><?php _e("Delay between each slides in milliseconds (default : 5000 ms)", 'customizr-pro' ); ?></h4>
               </div>
               <div class="meta-box-item-content">
               ...
               <div class="meta-box-item-title">
                  <h4><?php _e("Slider Layout : set the slider in full width", 'customizr-pro' );  ?></h4>
               </div>
               <div class="meta-box-item-content">
                  <?php
               ...
               <?php if ( CZR_IS_MODERN_STYLE ) : ?>
                   <div class="meta-box-item-title">
                      <h4><?php _e("Apply a dark overlay on your slider's images", 'customizr-pro' );  ?></h4>
                   </div>
                   <div class="meta-box-item-content">
                      <?php
                   ...
                   <div class="meta-box-item-title">
                      <h4><?php _e("Display navigation dots at the bottom of your slider.", 'customizr-pro' );  ?></h4>
                   </div>
                   <div class="meta-box-item-content">
                      <?php
              ...
              <?php endif; ?>
               <?php if (isset( $current_post_slides)) : ?>
                    <div style="z-index: 1000;position: relative;">
                      <p style="display: inline-block;float: right;"><a href="#TB_inline?width=350&height=100&inlineId=post_slider-warning-message" class="thickbox"><?php _e( 'Delete this slider' , 'customizr-pro' ) ?></a></p>
                    </div>
                    <div id="post_slider-warning-message" style="display:none;">
                      <div style="text-align:center">
                         <p>
                           <?php _e( 'The slider will be deleted permanently (images, call to actions and link will be kept).' , 'customizr-pro' ) ?>
                        </p>
                          <br/>
                           <a class="button-secondary" id="delete-slider" href="#" title="<?php _e( 'Delete slider' , 'customizr-pro' ); ?>" onClick="javascript:window.parent.tb_remove()"><?php _e( 'Delete slider' , 'customizr-pro' ); ?></a>
                      </div>
                    </div>
           ...
           <?php else://if no slider created yet and no slider of posts addon?>
                ...
                <div class="meta-box-item-content">
                  <p class="description"> <?php _e("You haven't create any slider yet. Go to the media library, edit your images and add them to your sliders.", "customizr-pro" ) ?><br/>
                  </p>
                  <br />
               </div>
             <?php endif; //sliders? ?>
      ...
      */
      ...
      function czr_fn_attachment_meta_box( $id ) {//id, title, callback, post_type, context, priority, callback_args
         ...
         add_meta_box(
            'slider_sectionid' ,
            __( 'Slider Options' , 'customizr-pro' ),
       ...
       */
        function czr_fn_attachment_slider_box( $post ) {
           ...
           ?>
          <div class="meta-box-item-title">
             <h4><label for="<?php echo $slider_check_id; ?>"><?php _e( 'Add to a slider (create one if needed)' , 'customizr-pro' ) ?></label></h4>
           </div>
           <div class="meta-box-item-content">
             <input name="tc_post_id" id="tc_post_id" type="hidden" value="<?php echo $post-> ID ?>"/>
              <?php
       ...
       */
        function czr_fn_get_attachment_slider_infos( $postid ) {
         ...
         if ( $slider_check_value == true )  {
            ?>
           <div class="meta-box-item-title">
               <h4><?php _e( 'Title text (80 char. max length)' , 'customizr-pro' ); ?></h4>
           </div>
           <div class="meta-box-item-content">
           ...
           <div class="meta-box-item-title">
               <h4><?php _e( 'Description text (below the title, 250 char. max length)' , 'customizr-pro' ); ?></h4>
           </div>
           <div class="meta-box-item-content">
            ...
            <div class="meta-box-item-title">
               <h4><?php _e("Title and text color", 'customizr-pro' );  ?></h4>
           </div>
           <div class="meta-box-item-content">
           ...
           <div class="meta-box-item-title">
               <h4><?php _e("Choose a linked page or post (among the last 100).", 'customizr-pro' ); ?></h4>
           </div>
           <div class="meta-box-item-content">
               <select name="<?php echo esc_attr( $link_id); ?>" id="<?php echo esc_attr( $link_id); ?>">
                 <?php //no link option ?>
                 <option value="" <?php selected( $link_value, $current = null, $echo = true ) ?>> <?php _e( 'No link' , 'customizr-pro' ); ?></option>
           ...
           <div class="meta-box-item-title">
               <h4><?php _e("or a custom link (leave this empty if you already selected a page or post above)", 'customizr-pro' ); ?></h4>
           </div>
           <div class="meta-box-item-content">
           ...
           <div class="meta-box-item-title">
               <h4><?php _e("Open link in a new page/tab", 'customizr-pro' );  ?></h4>
           </div>
           <div class="meta-box-item-content">
               <?php
                  CZR_meta_boxes::czr_fn_checkbox_view( array(
           ...
           <div class="meta-box-item-title">
               <h4><?php _e("Link the whole slide", 'customizr-pro' );  ?></h4>
           </div>
           <div class="meta-box-item-content">
               <?php
                  CZR_meta_boxes::czr_fn_checkbox_view( array(
           ...
           <?php if (!empty( $sliders)) : ?>
             <div class="meta-box-item-content">
                 ...
                 <select name="<?php echo esc_attr( $post_slider_id); ?>" id="<?php echo esc_attr( $post_slider_id); ?>">
                  <?php //no link option ?>
                  <option value="" <?php selected( $current_post_slider, $current = null, $echo = true ) ?>> <?php _e( '&mdash; Select a slider &mdash; ' , 'customizr-pro' ); ?></option>
                 ...
                 <span class="button-primary" id="tc_create_slider"><?php _e( 'Add a slider' , 'customizr-pro' ) ?></span>
                 <span class="spinner" style="float: left;visibility:visible;display: none;"></span>
                 <?php if (isset( $current_post_slides)) : ?>
                    <p style="text-align:right"><a href="#TB_inline?width=350&height=100&inlineId=slider-warning-message" class="thickbox"><?php _e( 'Delete this slider' , 'customizr-pro' ) ?></a></p>
           ...
           <?php else : //if no slider created yet ?>
                ...
                <div class="meta-box-item-content">
                  <p class="description"> <?php _e("You haven't create any slider yet. Write a slider name and click on the button to add you first slider.", "customizr-pro" ) ?><br/>
                  <input name="<?php echo $slider_id  ?>" id="<?php echo $slider_id ?>" value=""/>
                  <span class="button-primary" id="tc_create_slider"><?php _e( 'Add a slider' , 'customizr-pro' ) ?></span>
      ...
      */
      ...
      function czr_fn_show_slides ( $current_post_slides,$current_attachement_id) {
         ...
         <?php if(empty( $current_post_slides)) : ?>
           <div class="meta-box-item-content">
              <p class="description"> <?php _e("This slider has not slides to show. Go to the media library and start adding images to it.", "customizr-pro" ) ?><br/>
              </p>
             <br />
           </div>
         <?php else : // render?>
           <div id="tc_slides_table">
             <div id="update-status"></div>
                 <table class="wp-list-table widefat fixed media" cellspacing="0">
                  <thead>
                      <tr>
                        <th scope="col"><?php _e( 'Slide Image' , 'customizr-pro' ) ?></th>
                        <th scope="col"><?php _e( 'Title' , 'customizr-pro' ) ?></th>
                        <th scope="col" style="width: 35%"><?php _e( 'Slide Text' , 'customizr-pro' ) ?></th>
                        <th scope="col"><?php _e( 'Button Text' , 'customizr-pro' ) ?></th>
                        <th scope="col"><?php _e( 'Link' , 'customizr-pro' ) ?></th>
                        <th scope="col"><?php _e( 'Edit' , 'customizr-pro' ) ?></th>
                      </tr>
                    </thead>
                  <tbody id="sortable">
                    <?php
                        ...
                        <td style="vertical-align:middle" class="column-icon">
                           ...
                           <?php else : ?>
                             <div style="height:100px;width:100px;background:#eee;text-align:center;line-height:100px;vertical-align:middle">
                               <?php _e( 'No Image Selected' , 'customizr-pro' ); ?>
                             </div>
                           <?php endif; ?>
                        </td>
                        ...
                        <td style="vertical-align:middle" class="">
                         ...
                         <td style="vertical-align:middle" class="">
                           <?php if( $id != $current_attachement_id) : ?>
                             <a class="button-primary" href="<?php echo admin_url( 'post.php?post='.$id.'&action=edit' ) ?>" target="_blank"><?php _e( 'Edit this slide' , 'customizr-pro' )?></a>
                           <?php else : ?>
                             <span style="color:#999898"><?php _e( 'Current slide' , 'customizr-pro' )?></span>
                           <?php endif; ?>
                        </td>
                      </tr>
                      <?php
                  ...
                  <div class="tc-add-slide-notice">
                    <?php
                      printf('<p>%1$s</p><p>%2$s <a href="%3$s" title="%4$s" target="_blank">%4$s &raquo;</a>.</p>',
                        __('To add another slide : navigate to your media library (click on Media), open the edit screen of an image ( or add a new image ), and add it to your desired slider by using the dedicated option block at the bottom of the page.' , 'customizr-pro'),
                        __('For more informations about sliders, check the documentation page :' , 'customizr-pro'),
                        esc_url('http://docs.presscustomizr.com/search?query=slider'),
                        __('Slider documentation' , 'customizr-pro')
                      );
                    ?>
                  </div>
             </div><!-- //#tc_slides_table -->
