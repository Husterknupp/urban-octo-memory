  ...
  class CZR_BASE {
        ...
        function __construct( $_args = array()) {
            ...
            $this->sidebar_widgets    = array(
              'left'          => array(
                              'name'                 => __( 'Left Sidebar' , 'customizr-pro' ),
                              'description'          => __( 'Appears on posts, static pages, archives and search pages' , 'customizr-pro' )
              ),
              'right'         => array(
                              'name'                 => __( 'Right Sidebar' , 'customizr-pro' ),
                              'description'          => __( 'Appears on posts, static pages, archives and search pages' , 'customizr-pro' )
              )
            );//end of array
            ...
            $this->old_socials            = array(
              'tc_rss'            => array(
                                      'link_title'    => __( 'Subscribe to my rss feed' , 'customizr-pro' ),
                                      'default'       => get_bloginfo( 'rss_url' ) //kept as it's the only one used in the transition
                                  ),
              'tc_email'          => array(
                                      'link_title'    => __( 'E-mail' , 'customizr-pro' ),
                                    ),
              'tc_twitter'        => array(
                                      'link_title'    => __( 'Follow me on Twitter' , 'customizr-pro' ),
                                    ),
              'tc_facebook'       => array(
                                      'link_title'    => __( 'Follow me on Facebook' , 'customizr-pro' ),
                                    ),
              'tc_google'         => array(
                                      'link_title'    => __( 'Follow me on Google+' , 'customizr-pro' ),
                                    ),
              'tc_instagram'      => array(
                                      'link_title'    => __( 'Follow me on Instagram' , 'customizr-pro' ),
                                    ),
              'tc_tumblr'       => array(
                                      'link_title'    => __( 'Follow me on Tumblr' , 'customizr-pro' ),
                                    ),
              'tc_flickr'       => array(
                                      'link_title'    => __( 'Follow me on Flickr' , 'customizr-pro' ),
                                    ),
              'tc_wordpress'      => array(
                                      'link_title'    => __( 'Follow me on WordPress' , 'customizr-pro' ),
                                    ),
              'tc_youtube'        => array(
                                      'link_title'    => __( 'Follow me on Youtube' , 'customizr-pro' ),
                                    ),
              'tc_pinterest'      => array(
                                      'link_title'    => __( 'Pin me on Pinterest' , 'customizr-pro' ),
                                    ),
              'tc_github'         => array(
                                      'link_title'    => __( 'Follow me on Github' , 'customizr-pro' ),
                                    ),
              'tc_dribbble'       => array(
                                      'link_title'    => __( 'Follow me on Dribbble' , 'customizr-pro' ),
                                    ),
              'tc_linkedin'       => array(
                                      'link_title'    => __( 'Follow me on LinkedIn' , 'customizr-pro' ),
                                    ),
              'tc_vk'             => array(
                                      'link_title'    => __( 'Follow me on VKontakte' , 'customizr-pro' ),
                                    ),
              'tc_yelp'           => array(
                                      'link_title'    => __( 'Follow me on Yelp' , 'customizr-pro' ),
                                    ),
              'tc_xing'           => array(
                                      'link_title'    => __( 'Follow me on Xing' , 'customizr-pro' ),
                                    ),
              'tc_snapchat'       => array(
                                      'link_title'    => __( 'Contact me on Snapchat' , 'customizr-pro' ),
                                    )
            );//end of social array
            ...
            $this->font_pairs             = array(
              'gfont' => array(
                'name'  => __('Google fonts pairs' , 'customizr-pro'),
              ...
              'wsfont' => array(
                'name'  => __('Web safe fonts pairs' , 'customizr-pro'),
             ...
             'default' => array(
              'name'  => __('Single fonts' , 'customizr-pro'),
            ...
            $this->default_slides     = array(
                1 => array(
                  ...
                  'slide_background'       =>  sprintf('<img width="1910" height="750" src="%1$s" class="" alt="%2$s" />',
                                              ...
                                              __( 'Customizr is a clean responsive theme' , 'customizr-pro' )
                                      )
                ),
                ...
                2 => array(
                  ...
                  'slide_background'       =>  sprintf('<img width="1910" height="750" src="%1$s" class="" alt="%2$s" />',
                                              ...
                                              __( 'Many layout and design options are available from the WordPress customizer screen : see your changes live !' , 'customizr-pro' )
                                      )
                )
            );///end of slides array
        }//construct
        ...
        */
        function czr_fn_register_menus() {
            ...
            register_nav_menu( 'main' , __( 'Main Menu' , 'customizr-pro' ) );
            register_nav_menu( 'secondary' , __( 'Secondary (horizontal) Menu' , 'customizr-pro' ) );
            if ( CZR_IS_MODERN_STYLE ) {
              register_nav_menu( 'topbar' , __( 'Horizontal Top Bar Menu. (make sure that the topbar is displayed in the header settings ).' , 'customizr-pro' ) );
              register_nav_menu( 'mobile' , __( 'Mobile Menu' , 'customizr-pro' ) );
            }
        }
...
function czr_fn_load_social_links_module() {
    ...
    czr_fn_register_social_links_module(
        array(
            ...
            'section' => array(
                'id' => 'socials_sec',
                'title' => __( 'Social links', 'customizr-pro' ),
