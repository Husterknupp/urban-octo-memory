...
<section class="post-related-articles czr-carousel <?php czr_fn_echo('element_class') ?>" id="related-posts-section" <?php czr_fn_echo('element_attributes') ?>>
  <header class="row flex-row">
    <h3 class="related-posts_title col"><?php _e('You may also like', 'customizr-pro') ?></h3>
    ...
    ?>
      <div class="related-posts_nav col col-auto">
        <span class="btn btn-skin-dark inverted czr-carousel-prev slider-control czr-carousel-control disabled <?php echo $_icon_prev ?>" title="<?php esc_attr_e('Previous related articles', 'customizr-pro')?>" tabindex="0"></span>
        <span class="btn btn-skin-dark inverted czr-carousel-next slider-control czr-carousel-control <?php echo $_icon_next ?>" title="<?php esc_attr_e('Next related articles', 'customizr-pro')?>" tabindex="0"></span>
      </div>
    <?php endif ?>
  </header>
