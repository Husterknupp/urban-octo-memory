      ...
      function __construct () {
          ...
          $this -> global_layout      = array(
              'r' => array(
                  'content'       => 'span9',
                  'sidebar'       => 'span3',
                  'customizer'    => __( 'Right sidebar' , 'customizr-pro' ),
                  'metabox'       => __( 'Right sidebar' , 'customizr-pro' ),
              ),
              'l' => array(
                  'content'       => 'span9',
                  'sidebar'       => 'span3',
                  'customizer'    => __( 'Left sidebar' , 'customizr-pro' ),
                  'metabox'       => __( 'Left sidebar' , 'customizr-pro' ),
              ),
              'b' => array(
                  'content'       => 'span6',
                  'sidebar'       => 'span3',
                  'customizer'    => __( '2 sidebars : Right and Left' , 'customizr-pro' ),
                  'metabox'       => __( '2 sidebars : Right and Left' , 'customizr-pro' ),
              ),
              'f' => array(
                  'content'       => 'span12',
                  'sidebar'       => false,
                  'customizer'    => __( 'No sidebars : full width layout', 'customizr-pro' ),
                  'metabox'       => __( 'No sidebars : full width layout' , 'customizr-pro' ),
              ),
          );

          //Default skins array
          $this -> skins              =  array(
              'blue.css'        =>  __( 'Blue' , 'customizr-pro' ),
              'black.css'       =>  __( 'Black' , 'customizr-pro' ),
              'black2.css'      =>  __( 'Flat black' , 'customizr-pro' ),
              'grey.css'        =>  __( 'Grey' , 'customizr-pro' ),
              'grey2.css'       =>  __( 'Light grey' , 'customizr-pro' ),
              'purple2.css'     =>  __( 'Flat purple' , 'customizr-pro' ),
              'purple.css'      =>  __( 'Purple' , 'customizr-pro' ),
              'red2.css'        =>  __( 'Flat red' , 'customizr-pro' ),
              'red.css'         =>  __( 'Red' , 'customizr-pro' ),
              'orange.css'      =>  __( 'Orange' , 'customizr-pro' ),
              'orange2.css'     =>  __( 'Flat orange' , 'customizr-pro'),
              'yellow.css'      =>  __( 'Yellow' , 'customizr-pro' ),
              'yellow2.css'     =>  __( 'Flat yellow' , 'customizr-pro' ),
              'green.css'       =>  __( 'Green' , 'customizr-pro' ),
              'green2.css'      =>  __( 'Light green' , 'customizr-pro'),
              'blue3.css'       =>  __( 'Green blue' , 'customizr-pro'),
              'blue2.css'       =>  __( 'Light blue ' , 'customizr-pro' )
          );
          ...
          $this -> footer_widgets     = array(
              'footer_one'    => array(
                              'name'                 => __( 'Footer Widget Area One' , 'customizr-pro' ),
                              'description'          => __( 'Just use it as you want !' , 'customizr-pro' )
              ),
              'footer_two'    => array(
                              'name'                 => __( 'Footer Widget Area Two' , 'customizr-pro' ),
                              'description'          => __( 'Just use it as you want !' , 'customizr-pro' )
              ),
              'footer_three'   => array(
                              'name'                 => __( 'Footer Widget Area Three' , 'customizr-pro' ),
                              'description'          => __( 'Just use it as you want !' , 'customizr-pro' )
              )
          );//end of array
        ...
        foreach ( $tc_translatable_raw_options as $tc_translatable_option )
          if ( isset( $tc_options[$tc_translatable_option] ) ) {
            switch ( $tc_translatable_option ) {
              case 'tc_front_slider'             : $label = __( 'Front page slider name', 'customizr-pro' );
                                                   break;
              case 'tc_posts_slider_button_text' : $label = __( 'Posts slider button text', 'customizr-pro' );
                                                   break;
    ...
    private function czr_fn_set_event_tickets_compat() {
      ...
      */
      ...
      function czr_fn_et_ticket_fix_custom_page( $what ) {
        return str_replace( __( 'Custom Page Example', 'customizr-pro' ), 'custom-page.php', $what );
      }
       ...
       <div class="tc-wc-menu tc-open-on-hover span1">
         <ul class="tc-wc-header-cart nav tc-hover-menu">
           <li class="<?php echo esc_attr( $_main_item_class ); ?> menu-item">
             <a class="cart-contents" href="<?php echo $wc_cart_url; ?>" title="<?php _e( 'View your shopping cart', 'customizr-pro' ); ?>">
      ...
      function czr_fn_site_identity_option_map( $_map, $get_default = null ) {
            ...
            $_to_add = array(
                  'tc_sticky_logo_upload'  => array(
                                    ...
                                    'label'     =>  __( 'Sticky Logo Upload (supported formats : .jpg, .png, .gif, svg, svgz)' , 'customizr-pro' ),
                            ...
                            //we can define suggested cropping area and allow it to be flexible (def 150x150 and not flexible)
                                    ...
                                    'dst_width'  => false,
                                    'dst_height'  => false,
                                    'notice'    => __( "Use this upload control to specify a different logo on sticky header mode." , 'customizr-pro')
                  ),
                  //favicon
                  'tc_fav_upload' => array(
                                    'control'   =>  'CZR_Customize_Upload_Control' ,
                                    'label'       => __( 'Favicon Upload (supported formats : .ico, .png, .gif)' , 'customizr-pro' ),
                                    'title'     => __( 'FAVICON' , 'customizr-pro'),
                                    'section'   =>  'title_tagline' ,
                                    'type'      => 'tc_upload',
                                    'sanitize_callback' => 'czr_fn_sanitize_number',
                                    'priority'  => 25,
      ...
      function czr_fn_skin_option_map( $_map, $get_default = null ) {
            ...
            $_to_add = array(
                  ...
                  'tc_skin'     => array(
                              ...
                              'label'     =>  __( 'Choose a predefined skin' , 'customizr-pro' ),
                              'section'   =>  'skins_sec' ,
                              'type'      =>  'select' ,
                              'choices'    =>  $get_default ? null : $this -> czr_fn_build_skin_list(),
                              'transport'   =>  'postMessage',
                              'notice'    => __( 'Disabled if the random option is on.' , 'customizr-pro' )
                  ),
                  'tc_skin_random' => array(
                              'default'   => 0,
                              'control'   => 'CZR_controls',
                              'label'     => __('Randomize the skin', 'customizr-pro'),
                              'section'   => 'skins_sec',
                              'type'      => 'nimblecheck',
                              'notice'    => __( 'Apply a random color skin on each page load.' , 'customizr-pro' )
                  ),
            );
      ...
      function czr_fn_links_option_map( $_map, $get_default = null ) {
            ...
            $_to_add = array(
                  'tc_link_hover_effect'  =>  array(
                                'default'       => 1,
                                'control'     => 'CZR_controls' ,
                                'label'         => __( "Fade effect on link hover" , 'customizr-pro' ),
      ...
      function czr_fn_formatting_option_map( $_map, $get_default = null ) {
            ...
            $_to_add = array(
                  'tc_ext_link_style'  =>  array(
                                    'default'       => 0,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Display an icon next to external links" , "customizr-pro" ),
                                    'section'       => 'formatting_sec' ,
                                    'type'          => 'nimblecheck' ,
                  ...
                  'tc_ext_link_target'  =>  array(
                                    'default'       => 0,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Open external links in a new tab" , "customizr-pro" ),
                                    'section'       => 'formatting_sec' ,
                                    'type'          => 'nimblecheck' ,
                                    'notice'    => __( 'This will be applied to the links included in post or page content only.' , 'customizr-pro' ),
                  ),
                  'tc_enable_dropcap'  =>  array(
                                    'default'       => 0,
                                    'title'         => __( 'Drop caps', 'customizr-pro'),
                                    'label'         => __('Enable drop caps' , 'customizr-pro'),
                                    'control'       => 'CZR_controls' ,
                                    'notice'         => __( "Apply a drop cap to the first paragraph of your post / page content" , "customizr-pro" ),
                                    'section'       => 'formatting_sec' ,
                                    'type'          => 'nimblecheck',
                  ),
                  'tc_dropcap_minwords'  =>  array(
                                    ...
                                    'sanitize_callback' => 'czr_fn_sanitize_number',
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Apply a drop cap when the paragraph includes at least the following number of words :" , "customizr-pro" ),
                                    'notice'         => __( "(number of words)" , "customizr-pro" ),
                                    'section'       => 'formatting_sec' ,
                                    'type'          => 'number' ,
                                    'step'          => 1,
                                    'min'           => 1,
                  ...
                  'tc_dropcap_design' => array(
                                    'default'     => 'skin-shadow',
                                    'control'     => 'CZR_controls',
                                    'label'       => __( 'Drop cap style' , 'customizr-pro' ),
                                    'section'     => 'formatting_sec',
                                    'type'      =>  'select' ,
                                    'choices'     => array(
                                            'skin-shadow'    => __( "Primary theme color with a shadow" , 'customizr-pro' ),
                                            'simple-black'   => __( 'Simple black' , 'customizr-pro' ),
                                    ),
                  ),
                  'tc_post_dropcap'  =>  array(
                                    'default'       => 0,
                                    'label'         => __('Enable drop caps in posts' , 'customizr-pro'),
                                    'control'       => 'CZR_controls' ,
                                    'notice'         => __( "Apply a drop cap to the first paragraph of your single posts content" , "customizr-pro" ),
                                    'section'       => 'formatting_sec' ,
                                    'type'          => 'nimblecheck',
                  ),
                  'tc_page_dropcap'  =>  array(
                                    'default'       => 0,
                                    'label'         => __('Enable drop caps in pages' , 'customizr-pro'),
                                    'control'       => 'CZR_controls' ,
                                    'notice'         => __( "Apply a drop cap to the first paragraph of your pages" , "customizr-pro" ),
                                    'section'       => 'formatting_sec' ,
                                    'type'          => 'nimblecheck',
                  )
            );
      ...
      function czr_fn_icons_option_map( $get_default = null ) {
            ...
            return array(
                  'tc_show_title_icon'  =>  array(
                                    'default'       => 1,
                                    'control'     => 'CZR_controls' ,
                                    'label'         => __( "Display icons next to titles" , 'customizr-pro' ),
                                    'section'       => 'titles_icons_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 10,
                                    'notice'    => __( 'When this option is checked, a contextual icon is displayed next to the titles of pages, posts, archives, and WP built-in widgets.' , 'customizr-pro' ),
                                    'transport'   => 'postMessage'
                  ),
                  'tc_show_page_title_icon'  =>  array(
                                    'default'       => czr_fn_user_started_before_version( '3.3.0', '1.0.11' ) ? 1 : 0,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Display a page icon next to the page title" , 'customizr-pro' ),
                                    'section'       => 'titles_icons_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 20,
                                    'transport'   => 'postMessage'
                  ...
                  'tc_show_post_title_icon'  =>  array(
                                    'default'       => czr_fn_user_started_before_version( '3.3.0', '1.0.11' ) ? 1 : 0,
                                    'control'     => 'CZR_controls' ,
                                    'label'         => __( "Display a post icon next to the single post title" , 'customizr-pro' ),
                                    'section'       => 'titles_icons_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 30,
                                    'transport'   => 'postMessage'
                  ...
                  'tc_show_archive_title_icon'  =>  array(
                                    'default'       => 1,
                                    'control'     => 'CZR_controls' ,
                                    'label'         => __( "Display an icon next to the archive title" , 'customizr-pro' ),
                                    'section'       => 'titles_icons_sec' ,
                                    'type'          => 'nimblecheck',
                                    'notice'    => __( 'When this option is checked, an archive type icon is displayed in the heading of every types of archives, on the left of the title. An archive page can be : category, tag, author, date archive, custom taxonomies, search results.' , 'customizr-pro' ),
                                    'priority'      => 40,
                                    'transport'   => 'postMessage'
                  ),
                  'tc_show_post_list_title_icon'  =>  array(
                                    'default'       => czr_fn_user_started_before_version( '3.3.0' , '1.0.11' ) ? 1 : 0,
                                    'control'     => 'CZR_controls' ,
                                    'label'         => __( "Display an icon next to each post title in an archive page" , 'customizr-pro' ),
                                    'section'       => 'titles_icons_sec' ,
                                    'type'          => 'nimblecheck',
                                    'notice'    => __( 'When this option is checked, a post type icon is displayed on the left of each post titles in an archive page. An archive page can be : category, tag, author, date archive, custom taxonomies, search results.' , 'customizr-pro' ),
                                    'priority'      => 50,
                                    'transport'   => 'postMessage'
                  ),
                  'tc_show_sidebar_widget_icon'  =>  array(
                                    'default'       => 1,
                                    'control'     => 'CZR_controls' ,
                                    'label'         => __( "WP sidebar widgets : display icons next to titles" , 'customizr-pro' ),
                                    'section'       => 'titles_icons_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 60,
                                    'transport'   => 'postMessage'
                  ...
                  'tc_show_footer_widget_icon'  =>  array(
                                    'default'       => 1,
                                    'control'     => 'CZR_controls' ,
                                    'label'         => __( "WP footer widgets : display icons next to titles" , 'customizr-pro' ),
                                    'section'       => 'titles_icons_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 70,
                                    'transport'   => 'postMessage'
      ...
      function czr_fn_images_option_map( $_map, $get_default = null ) {
            ...
            $_to_add  = array(
                  ...
                  'tc_fancybox_autoscale' =>  array(
                                    'default'       => 1,
                                    'control'   => 'CZR_controls' ,
                                    'label'       => __( 'Autoscale images on zoom' , 'customizr-pro' ),
                                    'section'     => 'images_sec' ,
                                    'type'        => 'nimblecheck' ,
                                    'priority'    => 2,
                                    'notice'    => __( 'If enabled, this option will force images to fit the screen on lightbox zoom.' , 'customizr-pro' ),
                  ),

                 'tc_display_slide_loader'  =>  array(
                                    'default'       => 1,
                                    'control'   => 'CZR_controls' ,
                                    'label'       => __( "Sliders : display on loading icon before rendering the slides" , 'customizr-pro' ),
                                    'section'     => 'images_sec' ,
                                    'type'        => 'nimblecheck' ,
                                    'priority'    => 15,
                                    'notice'    => __( 'When checked, this option displays a loading icon when the slides are being setup.' , 'customizr-pro' ),
                  ),
            ...
            if ( version_compare( $wp_version, '4.4', '>=' ) ) {
                  $_to_add[ 'tc_resp_slider_img' ] =  array(
                                    'default'     => 0,
                                    'control'     => 'CZR_controls' ,
                                    'label'       => __( 'Improve your page speed by loading smaller slider images for mobile devices' , 'customizr-pro' ),
                                    'section'     => 'images_sec' ,
                                    'type'        => 'nimblecheck' ,
                                    'priority'    => 24,
                                    'ubq_section'   => array(
      ...
      function czr_fn_header_design_option_map( $_map, $get_default = null ) {
            ...
            $_to_add  = array(
                  'tc_social_in_header' =>  array(
                                    'default'       => 1,
                                    'label'       => __( 'Social links in header' , 'customizr-pro' ),
                                    'control'   =>  'CZR_controls' ,
                  ...
                  'tc_show_tagline'  =>  array(
                                    'default'       => 1,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Display the tagline in the header" , "customizr-pro" ),
                                    'section'       => 'header_layout_sec' ,
                                    'type'          => 'nimblecheck' ,
                                    'priority'      => 15,
                                    'transport'    => czr_fn_is_partial_refreshed_on() ? 'postMessage' : 'refresh',
                  ...
                  'tc_woocommerce_header_cart' => array(
                                   'default'   => 1,
                                   'label'     => sprintf('<span class="dashicons dashicons-cart"></span> %s', __( "Display the shopping cart in the header" , 'customizr-pro' ) ),
                                   'control'   => 'CZR_controls' ,
                                   'section'   => 'header_layout_sec',
                  ...
                  'tc_display_boxed_navbar'  =>  array(
                                    ...
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Display menu in a box" , 'customizr-pro' ),
                                    'section'       => 'header_layout_sec' ,
                                    'type'          => 'nimblecheck' ,
                                    'priority'      => 25,
                                    'transport'     => 'postMessage',
                                    'notice'        => __( 'If checked, this option wraps the header menu/tagline/social in a light grey box.' , 'customizr-pro' ),
                  ),
                  'tc_sticky_header'  =>  array(
                                    'default'       => 1,
                                    'control'       => 'CZR_controls' ,
                                    'title'         => __( 'Sticky header settings' , 'customizr-pro'),
                                    'label'         => __( "Sticky on scroll" , 'customizr-pro' ),
                                    'section'       => 'header_layout_sec' ,
                                    'type'          => 'nimblecheck' ,
                                    'priority'      => 30,
                                    'transport'     => 'postMessage',
                                    'notice'    => __( 'If checked, this option makes the header stick to the top of the page on scroll down.' , 'customizr-pro' )
                  ),
                  'tc_sticky_show_tagline'  =>  array(
                                    'default'       => 0,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Sticky header : display the tagline" , "customizr-pro" ),
                                    'section'       => 'header_layout_sec' ,
                                    'type'          => 'nimblecheck' ,
                                    'priority'      => 40,
                                    'transport'     => 'postMessage',
                  ...
                  'tc_woocommerce_header_cart_sticky' => array(
                                    'default'   => 1,
                                    'label'     => sprintf('<span class="dashicons dashicons-cart"></span> %s', __( "Sticky header: display the shopping cart" , "customizr-pro" ) ),
                                    'control'   => 'CZR_controls' ,
                                    'section'   => 'header_layout_sec',
                                    'type'      => 'nimblecheck' ,
                                    'priority'  => 45,
                                    'transport' => 'postMessage',
                                    'active_callback' => apply_filters( 'tc_woocommerce_options_enabled', '__return_false' ),
                                    'notice'    => __( 'WooCommerce: if checked, your WooCommerce cart icon will remain visible when scrolling.' , 'customizr-pro' )
                  ),
                  'tc_sticky_show_title_logo'  =>  array(
                                    'default'       => 1,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Sticky header : display the title / logo" , "customizr-pro" ),
                                    'section'       => 'header_layout_sec' ,
                                    'type'          => 'nimblecheck' ,
                                    'priority'      => 50,
                                    'transport'     => 'postMessage',
                  ...
                  'tc_sticky_show_menu'  =>  array(
                                    'default'       => 1,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Sticky header : display the menu" , "customizr-pro" ),
                                    'section'       => 'header_layout_sec' ,
                                    'type'          => 'nimblecheck' ,
                                    'priority'      => 60,
                                    'transport'     => 'postMessage',
                                    'notice'        => __('Also applied to the secondary menu if any.' , 'customizr-pro')
                  ),
            );
      ...
      function czr_fn_navigation_option_map( $_map, $get_default = null ) {
            ...
            $_to_add  = array(
                  'tc_menu_resp_dropdown_limit_to_viewport'  =>  array(
                                    'default'       => 0,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => sprintf('<span class="dashicons dashicons-smartphone"></span> %s', __( "For mobile devices (responsive), limit the height of the dropdown menu block to the visible viewport." , 'customizr-pro' ) ),
                                    'section'       => 'nav' ,
                                    'type'          => 'nimblecheck' ,
                                    'priority'      => 35,
                                    //'transport'     => 'postMessage',
                  ...
                  'tc_display_menu_label'  =>  array(
                                    'default'       => 0,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( "Display a label next to the menu button." , 'customizr-pro' ),
                                    'section'       => 'nav' ,
                                    'type'          => 'nimblecheck' ,
                                    'priority'      => 45,
                                    'notice'        => __( 'Note : the label is hidden on mobile devices.' , 'customizr-pro' ),
                  ),
                  //override
                  'tc_menu_position'  =>  array(
                                    ...
                                    'choices'       => array(
                                            ...
                                            'pull-menu-center'    => __( 'Menu centered' , 'customizr-pro' ),
                                            'pull-menu-right'     => __( 'Menu on the right' , 'customizr-pro' )
                                    ),
                                    'priority'      => 50,
                                    'transport'     => 'postMessage',
                                    'notice'        => sprintf( '%1$s <a href="%2$s">%3$s</a>.',
                                        __("Note : the menu centered position is available only when" , 'customizr-pro'),
                                        "javascript:wp.customize.section('header_layout_sec').focus();",
                                        __("the logo is centered", 'customizr-pro')
                                    )
                  ),
                  //override
                  ...
                  'tc_second_menu_resp_setting'  =>  array(
                                    ...
                                    'control'       => 'CZR_controls' ,
                                    'label'         => sprintf('<span class="dashicons dashicons-smartphone"></span> %s', __( "Choose a mobile devices (responsive) behaviour for the secondary menu." , 'customizr-pro' ) ),
                                    'section'       => 'nav',
                                    'type'      =>  'select',
                                    'choices'     => array(
                                        'in-sn-before'   => __( 'Move before inside the side menu ' , 'customizr-pro'),
                                        'in-sn-after'   => __( 'Move after inside the side menu ' , 'customizr-pro'),
                                        'display-in-header'   => __( 'Display in the header' , 'customizr-pro'),
                                        'hide'   => __( 'Hide' , 'customizr-pro'  ),
                                    ),
                                    'priority'      => 90,
                  ),
      ...
      function czr_fn_post_metas_option_map( $_map, $get_default = null ){
            ...
            $_to_add  = array(
                  ...
                  'tc_post_metas_design'  =>  array(
                                    ...
                                    'control'       => 'CZR_controls' ,
                                    'title'         => __( 'Metas Design' , 'customizr-pro' ),
                                    'label'         => __( "Select a design for the post metas" , 'customizr-pro' ),
                                    'section'       => 'post_metas_sec' ,
                                    'type'          =>  'select' ,
                                    'choices'       => array(
                                        'buttons'     => __( 'Buttons and text' , 'customizr-pro' ),
                                        'no-buttons'  => __( 'Text only' , 'customizr-pro' )
                                    ),
                                    'priority'      => 10
                  ),
                  'tc_post_metas_update_date_format'  =>  array(
                                    'default'       => 'days',
                                    'control'       => 'CZR_controls',
                                    'label'         => __( "Select the last update format" , 'customizr-pro' ),
                                    'section'       => 'post_metas_sec',
                                    'type'          =>  'select' ,
                                    'choices'       => array(
                                            'days'     => __( 'No. of days since last update' , 'customizr-pro' ),
                                            'date'     => __( 'Date of the last update' , 'customizr-pro' )
                                    ),
                                    'priority'      => 55
                  ),
                  ...
                  'tc_post_metas_update_notice_in_title'  =>  array(
                                    ...
                                    'control'       => 'CZR_controls',
                                    'title'         => __( 'Recent update notice after post titles' , 'customizr-pro' ),
                                    'label'         => __( "Display a recent update notice" , 'customizr-pro' ),
                                    'section'       => 'post_metas_sec',
                                    'type'          => 'nimblecheck',
                                    'priority'      => 65,
                                    'notice'    => __( 'If this option is checked, a customizable recent update notice is displayed next to the post title.' , 'customizr-pro' )
                  ),
                  'tc_post_metas_update_notice_interval'  =>  array(
                                    'default'       => 10,
                                    'control'       => 'CZR_controls',
                                    'sanitize_callback' => 'czr_fn_sanitize_number',
                                    'label'         => __( "Display the notice if the last update is less (strictly) than n days old" , 'customizr-pro' ),
                                    'section'       => 'post_metas_sec',
                                    'type'          => 'number' ,
                                    'step'          => 1,
                                    'min'           => 0,
                                    'priority'      => 70,
                                    'notice'    => __( 'Set a maximum interval (in days) during which the last update notice will be displayed.' , 'customizr-pro' ),
                  ),
                  'tc_post_metas_update_notice_text'  =>  array(
                                    'default'       => __( "Recently updated !" , 'customizr-pro' ),
                                    'control'       => 'CZR_controls',
                                    'label'         => __( "Update notice text" , 'customizr-pro' ),
                                    'section'       => 'post_metas_sec',
                                    'type'          => 'text',
                                    'priority'      => 75,
                                    'transport'   => 'postMessage'
                  ...
                  'tc_post_metas_update_notice_format'  =>  array(
                                    ...
                                    'control'       => 'CZR_controls',
                                    'label'         => __( "Update notice style" , 'customizr-pro' ),
                                    'section'       => 'post_metas_sec',
                                    'type'          =>  'select' ,
                                    'choices'       => array(
                                            'label-default'   => __( 'Default (grey)' , 'customizr-pro' ),
                                            'label-success'   => __( 'Success (green)' , 'customizr-pro' ),
                                            'label-warning'   => __( 'Alert (orange)' , 'customizr-pro' ),
                                            'label-important' => __( 'Important (red)' , 'customizr-pro' ),
                                            'label-info'      => __( 'Info (blue)' , 'customizr-pro' )
                                    ),
                                    'priority'      => 80,
                                    'transport'   => 'postMessage'
                  )
            ...
            if ( isset( $_map[ 'tc_show_post_metas_update_date' ] ) )
                  $_map[ 'tc_show_post_metas_update_date' ]['notice'] = __( 'If this option is checked, additional date informations about the the last post update can be displayed (nothing will show up if the post has never been updated).' , 'customizr-pro' );
      ...
      function czr_fn_post_list_option_map( $_map, $get_default = null ) {
            ...
            $_to_add  = array(
                  ...
                  'tc_post_list_length' =>  array(
                                    'default'       => 'excerpt',
                                    'label'         => __( 'Select the length of posts in lists (home, search, archives, ...)' , 'customizr-pro' ),
                                    'section'       => 'post_lists_sec' ,
                                    'type'          => 'select' ,
                                    'choices'       => array(
                                            'excerpt'   => __( 'Display the excerpt' , 'customizr-pro' ),
                                            'full'    => __( 'Display the full content' , 'customizr-pro' )
                                            ),
                                    'priority'       => 20,
                  ),
                  //classic grid
                  'tc_grid_in_blog'  =>  array(
                                    'default'       => 1,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( 'Apply the grid layout to Home/Blog' , "customizr-pro" ),
                                    'section'       => 'post_lists_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 57
                  ),
                  'tc_grid_in_archive'  =>  array(
                                    'default'       => 1,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( 'Apply the grid layout to Archives (archives, categories, author posts)' , "customizr-pro" ),
                                    'section'       => 'post_lists_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 58
                  ),
                  'tc_grid_in_search'  =>  array(
                                    'default'       => 1,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( 'Apply the grid layout to Search results' , "customizr-pro" ),
                                    'section'       => 'post_lists_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 60,
                                    'notice'        => __( 'Unchecked contexts are displayed with the alternate thumbnails layout.' , 'customizr-pro' ),
                  ),
                  'tc_grid_icons'  =>  array(
                                    'default'       => 1,
                                    'control'       => 'CZR_controls' ,
                                    'label'         => __( 'Display post format icons' , "customizr-pro" ),
                                    'section'       => 'post_lists_sec' ,
                                    'type'          => 'nimblecheck',
                                    'priority'      => 63,
                                    'transport'     => 'postMessage'
                  ...
                  'tc_post_list_default_thumb'  => array(
                                    'control'   =>  version_compare( $wp_version, '4.3', '>=' ) ? 'CZR_Customize_Cropped_Image_Control' : 'CZR_Customize_Upload_Control',
                                    'label'         => __( 'Upload a default thumbnail' , 'customizr-pro' ),
                                    'section'   =>  'post_lists_sec' ,
                                    'sanitize_callback' => 'czr_fn_sanitize_number',
                            //we can define suggested cropping area and allow it to be flexible (def 150x150 and not flexible)
                                    'width'         => 570,
                  ...
                  'tc_grid_thumb_height' => array(
                                    ...
                                    'sanitize_callback' => 'czr_fn_sanitize_number',
                                    'control'       => 'CZR_controls' ,
                                    'title'         => __( 'Thumbnails max height for the grid layout' , 'customizr-pro' ),
                                    'label'         => __( "Set the post grid thumbnail's max height in pixels" , 'customizr-pro' ),
                                    'section'       => 'post_lists_sec' ,
                                    'type'          => 'number' ,
                                    'step'          => 1,
                                    'min'           => 0,
            ...
            $_map['tc_post_list_thumb_shape']['choices'] = array_merge( $_map['tc_post_list_thumb_shape']['choices'], array(
                                    'squared'               => __( 'Squared, expand on hover' , 'customizr-pro'),
                                    'squared-expanded'      => __( 'Squared, no expansion' , 'customizr-pro'),
                                    'rectangular'           => __( 'Rectangular with no effect' , 'customizr-pro'  ),
                                    'rectangular-blurred'   => __( 'Rectangular with blur effect on hover' , 'customizr-pro'  ),
                                    'rectangular-unblurred' => __( 'Rectangular with unblur effect on hover' , 'customizr-pro')
            ) );
            ...
            $_map['tc_post_list_thumb_position']['choices'] = array_merge( $_map['tc_post_list_thumb_position']['choices'], array(
                                    'top'     => __( 'Top' , 'customizr-pro' ),
                                    'bottom'    => __( 'Bottom' , 'customizr-pro' ),
            ) );
      ...
      function czr_fn_comment_option_map( $_map, $get_default = null ) {
            ...
            $_to_add  = array(
                  ...
                  'tc_comment_bubble_shape' => array(
                                  'default'     => 'default',
                                  'control'     => 'CZR_controls',
                                  'label'       => __( 'Comments bubble shape' , 'customizr-pro' ),
                                  'section'     => 'comments_sec',
                                  'type'      =>  'select' ,
                                  'choices'     => array(
                                          'default'             => __( "Small bubbles" , 'customizr-pro' ),
                                          'custom-bubble-one'   => __( 'Large bubbles' , 'customizr-pro' ),
                                  ),
                                  'priority'    => 10,
                  ),
                  /* Removed in c4 */
                  'tc_comment_bubble_color_type' => array(
                                  ...
                                  'control'     => 'CZR_controls',
                                  'label'       => __( 'Comments bubble color' , 'customizr-pro' ),
                                  'section'     => 'comments_sec',
                                  'type'      =>  'select' ,
                                  'choices'     => array(
                                          'skin'     => __( "Skin color" , 'customizr-pro' ),
      ...
      function czr_fn_sidebars_option_map( $_map, $get_default = null ) {
            ...
            $_to_add  = array(
                  ...
                  'tc_social_in_sidebar_title'  =>  array(
                                    'default'       => __( 'Social links' , 'customizr-pro' ),
                                    'label'       => __( 'Social link title in sidebars' , 'customizr-pro' ),
                                    'control'   =>  'CZR_controls' ,
                                    'section'     => 'sidebar_socials_sec',
                                    'type'        => 'text' ,
                                    'priority'       => 30,
                                    'transport'   => 'postMessage',
                                    'notice'    => __( 'Will be hidden if empty' , 'customizr-pro' )
                  )
      ...
      function czr_fn_responsive_option_map( $_map, $get_default = null ) {
            ...
            $_to_add  = array(
                  'tc_block_reorder'  =>  array(
                                    'default'       => 1,
                                    'control'   => 'CZR_controls' ,
                                    'label'         => sprintf('<span class="dashicons dashicons-smartphone"></span> %s', __( 'Dynamic sidebar reordering on small devices' , 'customizr-pro' ) ),
                                    'section'     => 'responsive_sec' ,
                                    'type'        => 'nimblecheck' ,
                                    'notice'    => __( 'Activate this option to move the sidebars (if any) after the main content block, for smartphones or tablets viewport.' , 'customizr-pro' ),
                  )
            );
      ...
      function czr_fn_popul_section_map( $_sections ) {
            ...
            $_old_sections = array(
                  ...
                  'titles_icons_sec'        => array(
                                      'title'     =>  __( 'Titles icons settings' , 'customizr-pro' ),
                                      'priority'    =>  $this->is_wp_version_before_4_0 ? 18 : 40,
                                      'description' =>  __( 'Set up the titles icons options' , 'customizr-pro' ),
                  ...
                  'responsive_sec'           => array(
                                      'title'     =>  __( 'Responsive settings' , 'customizr-pro' ),
                                      'priority'    =>  20,
                                      'description' =>  __( 'Various settings for responsive display' , 'customizr-pro' ),
      ...
      function czr_fn_get_style_note_content() {
        ...
        ob_start();
          ?>
              <?php
                  printf( '<br/><p>%1$s</p>',
                      sprintf( __('Quick tip : you can choose between two styles for the Customizr theme. Give it a try %s', 'customizr-pro'),
                          sprintf( '<a href="%1$s">%2$s</a>',
                              czr_fn_get_customizer_url( array( 'control' => 'tc_style', 'section' => 'style_sec') ),
                              __('in the live customizer.', 'customizr-pro')
                          )
                      )
                  );
              ?>
