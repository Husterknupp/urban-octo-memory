            ...
            'item-inputs' => array(
                'header-footer' => array(
                    ...
                    'choices'     => array(
                        ...
                        'nimble_local' => __('Nimble specific header and footer for this page ( beta )', 'nimble-builder' )
                    ),
                    'refresh_preview' => true,
                    'width-100'   => true,
                    'title_width' => 'width-100',
        ...
        'tmpl' => array(
            'item-inputs' => array(
                'use-custom-breakpoint' => array(
                    ...
                    'title_width' => 'width-80',
                    'input_width' => 'width-20',
                    'notice_before_title' => __( 'This is the breakpoint under which columns are reorganized vertically. The default global breakpoint is 768px. A custom breakpoint can also be set for each section.', 'nimble-builder')
                ),
        ...
        'tmpl' => array(
            'item-inputs' => array(
                'enable' => array(
                    ...
                    'title_width' => 'width-80',
                    'input_width' => 'width-20',
                    'notice_after' => sprintf( __('The Nimble Builder can activate the %1$s service to protect your forms against spambots. You need to %2$s.', 'nimble-builder'),
        ...
        'tmpl' => array(
            'item-inputs' => array(
                'beta-enabled' => array(
                    ...
                    'title_width' => 'width-80',
                    'input_width' => 'width-20',
                    'notice_before_title' => __( 'Check this option to try the upcoming features of the Nimble Builder. Available beta features as of December 2018 : header and footer customization, menu module, widget area module.', 'nimble-builder'),
